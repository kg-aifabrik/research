...
| [iac-k8s](iac-k8s/) | GCP→GKE IaC: day-0 manual bootstrap, Terraform + Config Sync + ArgoCD provisioning of hardened HA clusters for the FOP/Rafay + Management Plane, the GKE security standard (aligned to k8s-hardening), and Day-2 version/OS lifecycle. |
