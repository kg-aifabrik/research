...
![Multi-team RBAC: engineers and admin authenticate to the frontend's default authorizer + JWT claim mapper; read spans all namespaces, write is own-namespace only, delete is admin-only](diagrams/multi-tenancy-setup.png)
